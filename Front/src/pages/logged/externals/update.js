...
export default function UpdateExternal() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://10.10.135.100:3002/api/externals/${externalId}`).then((res) => {
            setExternalData(res.data);

            setText_machines(res.data[0].text_machines);
            setRequester(res.data[0].requester);
        ...
        axios.get(`http://10.10.135.100:3002/api/externals/${externalId}/machines`)
        .then((res) => {
        ...
        axios.get(`http://10.10.135.100:3002/api/externals/${externalId}/users`)
        .then((res) => {
    ...
    const updateExternal = () => {
        ...
        if (problem === null) {
            ...
            axios.patch(`http://10.10.135.100:3002/api/externals/${id}/update`, {
                entity: entity.value,
            ...
            .then(function (r) {
                ...
                if (oldMachines !== newMachines && newMachines !== null) {
                    axios.delete(`http://10.10.135.100:3002/api/externals/${id}/delete/itens-machine`)
                    .then((res) => {
                        for (let count = 0; count < newMachines.length; count++) {
                            axios.post("http://10.10.135.100:3002/api/externals/create/item-machine", {
                                id_service: id,
                ...
                if (oldUsers !== newUsers && newUsers !== null) {
                    axios.delete(`http://10.10.135.100:3002/api/externals/${id}/delete/itens-user`)
                    .then((res) => {
                        for (let count = 0; count < newUsers.length; count++) {
                            axios.post("http://10.10.135.100:3002/api/externals/create/item-user", {
                                id_service: id,
