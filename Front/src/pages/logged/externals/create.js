...
export default function CreateExternal() {
    ...
    const addExternal = () => {
        ...
        else if (date === null) alert('Defina uma data de agendamento!')
        else{
            axios.post("http://10.10.135.100:3002/api/externals/create", {
                entity: entity.value,
    ...
    return(
        <div className="create-update">
            ...
            <Form className="form-create-update">
                ...
                <Button color="primary" onClick={addExternal} disabled={isButtonDisabled}>Adicionar</Button>
