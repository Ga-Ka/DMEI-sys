...
export default function External() {
    ...
    const saveDocument = () => {
        ...
        if (doc === null) {
            ...
            axios.patch(`http://10.10.135.100:3002/api/externals/upload/doc/${id}`, doc, {
                headers: {
    ...
    async function downloadDoc(documentPath) {
        ...
        axios.get(`http://10.10.135.100:3002/api/externals/open/doc/?fileName=${encodeURIComponent(documentName)}`, {
            responseType: 'blob',
        })
        .then((res) => {
            console.log(res);
    ...
    const removeDocument = () => {
        axios.delete(`http://10.10.135.100:3002/api/externals/delete/doc/${id}`)
        .then((r)=>{
            setVer(!ver);
